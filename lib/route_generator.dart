...
class RouteGenerator {
  static Route<dynamic> generateRoute(RouteSettings settings) {
    ...
    switch (settings.name) {
      ...
      case '/cashbak':
        return MaterialPageRoute(
            builder: (_) => CashBackPages(currentTab: args));
      case '/cab':
        return MaterialPageRoute(builder: (_) => CabPages(currentTab: args));
      case '/shipment':
        return MaterialPageRoute(
            builder: (_) => ShipmentPages(currentTab: args));
      case '/Details':
        return MaterialPageRoute(
            builder: (_) =>
      ...
      case '/Redeban':
        return MaterialPageRoute(
            builder: (_) =>
                RedebanPaymentWidget(routeArgument: args as RouteArgument));
      case '/Settings':
      ...
      case '/TransactionCab':
        return MaterialPageRoute(
            builder: (_) =>
                TransactionCab(routeArgument: args as RouteArgument));
      case '/PaymentTrip':
        return MaterialPageRoute(
            builder: (_) =>
                PaymentCabWidget(routeArgument: args as RouteArgument));
      case '/Referidos':
        return MaterialPageRoute(builder: (_) => UsersReferWidget());
      case '/MapDelivery':
        return MaterialPageRoute(
            builder: (_) =>
                MapDeliveryWidget(routeArgument: args as RouteArgument));
      default:
