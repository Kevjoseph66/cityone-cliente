...
class RedebanController extends ControllerMVC {
  ...
  void initState() {
    ...
    url =
    '${GlobalConfiguration().getString('base_url')}payments/redeban/express-checkout?$_apiToken&$_userId&$_deliveryAddress&';
    print(url);
    setState(() {});
    super.initState();
  }
