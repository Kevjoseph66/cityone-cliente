                    ...
                    child: SingleChildScrollView(
                      child: Column(
                        children: <Widget>[
                          ...
                          _con.order.driverId != null && int.parse(_con.order.orderStatus.id) < 5 ?
                              Column(
                                children: [
                                  Text('Rastrear', style: Theme.of(context).textTheme.headline6.merge(TextStyle(letterSpacing: 1.3)),),
                                  IconButton(
                                      icon: Icon(Icons.location_on),
                                      onPressed: (){
                                        Navigator.of(context).pushNamed('/MapDelivery', arguments: RouteArgument(id: _con.order.driverId));
                                      },
