...
import 'package:markets/src/viewmodels/history_shipment_view_model.dart';
import 'package:stacked/stacked.dart';

class HistoryShipment extends StatelessWidget {
  final GlobalKey<ScaffoldState> parentScaffoldKey;

  HistoryShipment({Key key, this.parentScaffoldKey}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return ViewModelBuilder<HistoryShipmentViewModels>.reactive(
        disposeViewModel: false,
        viewModelBuilder: () => HistoryShipmentViewModels(),
        onModelReady: (model) {
          model.listenToTrips();
        },
